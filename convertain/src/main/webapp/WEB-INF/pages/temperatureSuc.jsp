	...
	<div class="currency-row-outer">
		<div class="currency-converter">
			...
			<!-- insert form here -->
             ...
             <%String from =(String) request.getAttribute("temperature"); %>
             <%String to =(String) request.getAttribute("temperatureto"); %>
			<form action="temperatureprocess" method="post">
			<div class="field grid-50-50">
				...
				<div class="colmun col-right">
					<div class="select">
						<select name="temperature" class="currency" onchange="updatevalue()">
			...
			<div class="field grid-50-50">
				...
				<div class="colmun col-right">
					<div class="select">
						<select name="temperatureto" class="currency" onchange="updatevalue()">
