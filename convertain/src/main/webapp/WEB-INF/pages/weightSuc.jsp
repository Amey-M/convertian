	...
	<div class="currency-row-outer">
		<div class="currency-converter">
			...
			<!-- insert form here -->
             ...
             <%String from =(String) request.getAttribute("weight"); %>
             <%String to =(String) request.getAttribute("weightto"); %>
			<form action="weightprocess" method="post">
			<div class="field grid-50-50">
				...
				<div class="colmun col-right">
					<div class="select">
						<select name="weight" class="currency" onchange="updatevalue()">
							...
							<option value="quint">qunital</option>
						</select>
					</div>
				</div>
			</div>
			<div class="field grid-50-50">
				...
				<div class="colmun col-right">
					<div class="select">
						<select name="weightto" class="currency" onchange="updatevalue()">
