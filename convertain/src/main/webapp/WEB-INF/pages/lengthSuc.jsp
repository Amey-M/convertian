...
<body>
	...
	<div class="currency-row-outer">
		<div class="currency-converter">
			...
			<!-- insert form here -->
			<form action="lengthprocess" method="post">
			<%double result =(double) request.getAttribute("to"); %>
            
             <%double uservalue =(double) request.getAttribute("from"); %>
            
             <%String from =(String) request.getAttribute("Length"); %>
             <%String to =(String) request.getAttribute("Lengthto"); %>
			<div class="field grid-50-50">
				...
				<div class="colmun col-right">
					<div class="select">
						<select name="Length" class="currency" onchange="updatevalue()">
							...
							<option value="light">Light year</option>
			...
			<div class="field grid-50-50">
				...
				<div class="colmun col-right">
					<div class="select">
						<select name="Lengthto" class="currency" onchange="updatevalue()">
