...
<nav class="navbar navbar-expand navbar-dark bg-dark">
	...
	<div class="currency-row-outer">
		<div class="currency-converter">
			...
			<!-- insert form here -->
			<%String result =(String) request.getAttribute("to"); %>
            
             <%String uservalue =(String) request.getAttribute("from"); %>
            
             <%String from =(String) request.getAttribute("numbersystem"); %>
             <%String to =(String) request.getAttribute("numbersystemto"); %>
			<form action="numbersystemprocess" method="post">
			<div class="field grid-50-50">
				...
				<div class="colmun col-right">
					<div class="select">
						<select name="numbersystem" class="currency" onchange="updatevalue()">
							<option style="color:blue" value=<%=from%> ><%=from.toUpperCase()%></option><option style="color:blue" value=<%=from%> ><%=from.toUpperCase()%></option>
			...
			<div class="field grid-50-50">
				...
				<div class="colmun col-right">
					<div class="select">
						<select name="numbersystemto" class="currency" onchange="updatevalue()">
