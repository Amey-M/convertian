	...
	<div class="currency-row-outer">
		<div class="currency-converter">
			...
			<!-- insert form here -->
             ...
             <%String from =(String) request.getAttribute("volume"); %>
             <%String to =(String) request.getAttribute("volumeto"); %>
			 <form action="volumeprocess" method="post">
			<div class="field grid-50-50">
				...
				<div class="colmun col-right">
					<div class="select">
						<select name="volume" class="currency" onchange="updatevalue()">
							  <option style="color:blue" value=<%=from%> ><%=from.toUpperCase()%></option>
							<option value="l">Liter</option>
							<option value="ml">mL</option>
							<option value="kl">Kilo liter</option>
			...
			<div class="field grid-50-50">
				...
				<div class="colmun col-right">
					<div class="select">
					 <select name="volumeto" class="currency" onchange="updatevalue()">
