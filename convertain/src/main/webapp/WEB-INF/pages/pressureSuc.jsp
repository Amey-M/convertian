	...
	<div class="currency-row-outer">
		<div class="currency-converter">
			...
			<%double result =(double) request.getAttribute("to"); %>
             ...
             <%String from =(String) request.getAttribute("pressure"); %>
             <%String to =(String) request.getAttribute("pressureto"); %>
             <form action="pressureprocess" method="post">
			<div class="field grid-50-50">
				<div class="colmun col-left">
					<input type="number" class="form-input" id="number" name="from"
						placeholder="FROM" value=<%=uservalue%>>
				</div>
				<div class="colmun col-right">
					<div class="select">
						<select name="pressure" class="currency" onchange="updatevalue()">
			...
			<div class="field grid-50-50">
				...
				<div class="colmun col-right">
					<div class="select">
						<select name="pressureto" class="currency" onchange="updatevalue()">
